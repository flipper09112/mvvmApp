...
public class ClientPageDetailsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.UI.Adapters.ViewPager.ClientPageDetailsAdapter, tabApp", ClientPageDetailsAdapter.class, __md_methods);
	}


	public ClientPageDetailsAdapter ()
	{
		super ();
		if (getClass () == ClientPageDetailsAdapter.class)
			mono.android.TypeManager.Activate ("tabApp.UI.Adapters.ViewPager.ClientPageDetailsAdapter, tabApp", "", this, new java.lang.Object[] {  });
	}
