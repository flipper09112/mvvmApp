package crc64191e40d90cf9f557;


public class ClientPageOrdersListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.UI.Adapters.ViewPager.ClientPageOrdersListAdapter, tabApp", ClientPageOrdersListAdapter.class, __md_methods);
	}


	public ClientPageOrdersListAdapter ()
	{
		super ();
		if (getClass () == ClientPageOrdersListAdapter.class)
			mono.android.TypeManager.Activate ("tabApp.UI.Adapters.ViewPager.ClientPageOrdersListAdapter, tabApp", "", this, new java.lang.Object[] {  });
	}
