...
public class PrintPreviewAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.UI.Adapters.OtherOptions.PrintPreviewAdapter, tabApp", PrintPreviewAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PrintPreviewAdapter.class)
			mono.android.TypeManager.Activate ("tabApp.UI.Adapters.OtherOptions.PrintPreviewAdapter, tabApp", "", this, new java.lang.Object[] {  });
	}
