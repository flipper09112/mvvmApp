...
public class HomePageMapFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.UI.Fragments.Home.ViewPager.HomePageMapFragment, tabApp", HomePageMapFragment.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == HomePageMapFragment.class)
			mono.android.TypeManager.Activate ("tabApp.UI.Fragments.Home.ViewPager.HomePageMapFragment, tabApp", "", this, new java.lang.Object[] {  });
	}


	public HomePageMapFragment (int p0)
	{
		super (p0);
		if (getClass () == HomePageMapFragment.class)
			mono.android.TypeManager.Activate ("tabApp.UI.Fragments.Home.ViewPager.HomePageMapFragment, tabApp", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
	}
