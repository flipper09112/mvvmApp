...
public class HomePageOrdersListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.UI.Adapters.Home.HomePageOrdersListAdapter, tabApp", HomePageOrdersListAdapter.class, __md_methods);
	}


	public HomePageOrdersListAdapter ()
	{
		super ();
		if (getClass () == HomePageOrdersListAdapter.class)
			mono.android.TypeManager.Activate ("tabApp.UI.Adapters.Home.HomePageOrdersListAdapter, tabApp", "", this, new java.lang.Object[] {  });
	}
