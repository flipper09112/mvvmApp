...
public class EditClientProfileItemsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.UI.Adapters.EditClient.EditClientProfileItemsAdapter, tabApp", EditClientProfileItemsAdapter.class, __md_methods);
	}


	public EditClientProfileItemsAdapter ()
	{
		super ();
		if (getClass () == EditClientProfileItemsAdapter.class)
			mono.android.TypeManager.Activate ("tabApp.UI.Adapters.EditClient.EditClientProfileItemsAdapter, tabApp", "", this, new java.lang.Object[] {  });
	}
