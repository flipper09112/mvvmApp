...
public class ClientPageSpinnerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.UI.Adapters.ClientPageSpinnerAdapter, tabApp", ClientPageSpinnerAdapter.class, __md_methods);
	}


	public ClientPageSpinnerAdapter ()
	{
		super ();
		if (getClass () == ClientPageSpinnerAdapter.class)
			mono.android.TypeManager.Activate ("tabApp.UI.Adapters.ClientPageSpinnerAdapter, tabApp", "", this, new java.lang.Object[] {  });
	}
