...
{
    public class GetFatProductRequest : BaseRequest<GetFatProductInput, GetFatProductOutput>, IGetFatProductRequest
    {
        protected override string EndPoint => "/items/find";
    }
}
