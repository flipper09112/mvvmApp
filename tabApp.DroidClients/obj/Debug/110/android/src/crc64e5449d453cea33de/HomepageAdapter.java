...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.DroidClients.UI.Adapters.HomepageAdapter, tabApp.DroidClients", HomepageAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == HomepageAdapter.class)
			mono.android.TypeManager.Activate ("tabApp.DroidClients.UI.Adapters.HomepageAdapter, tabApp.DroidClients", "", this, new java.lang.Object[] {  });
	}
