...
public class ProdutsListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tabApp.DroidClients.UI.Adapters.ProdutsListAdapter, tabApp.DroidClients", ProdutsListAdapter.class, __md_methods);
	}


	public ProdutsListAdapter ()
	{
		super ();
		if (getClass () == ProdutsListAdapter.class)
			mono.android.TypeManager.Activate ("tabApp.DroidClients.UI.Adapters.ProdutsListAdapter, tabApp.DroidClients", "", this, new java.lang.Object[] {  });
	}
