# Issue 36 - Migrar SynchronizeFragment para MAUI

## Meta
- Origem Android: `SynchronizeFragment`
- Destino MAUI: `SynchronizePage`
- ViewModel: `SynchronizeViewModel`
- Layout atual: `SynchronizeFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `1d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/SynchronizePage.xaml` e code-behind.
