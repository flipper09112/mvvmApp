# Issue 17 - Migrar EditDailyOrdersFragment para MAUI

## Meta
- Origem Android: `EditDailyOrdersFragment`
- Destino MAUI: `EditDailyOrdersPage`
...
- [ ] Criar `Views/EditDailyOrdersPage.xaml` e code-behind.
