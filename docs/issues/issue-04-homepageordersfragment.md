# Issue 04 - Migrar HomePageOrdersFragment para MAUI

## Meta
- Origem Android: `HomePageOrdersFragment`
- Destino MAUI: `HomePageOrdersPage`
- ViewModel: `HomeViewModel`
- Layout atual: `HomePageOrdersFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/HomePageOrdersPage.xaml` e code-behind.
