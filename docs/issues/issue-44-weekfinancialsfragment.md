# Issue 44 - Migrar WeekFinancialsFragment para MAUI

## Meta
- Origem Android: `WeekFinancialsFragment`
- Destino MAUI: `WeekFinancialsPage`
- ViewModel: `WeekFinancialsViewModel`
- Layout atual: `WeekFinancialsFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/WeekFinancialsPage.xaml` e code-behind.
