# Issue 28 - Migrar EditProductFragment para MAUI

## Meta
- Origem Android: `EditProductFragment`
- Destino MAUI: `EditProductPage`
- ViewModel: `EditProductViewModel`
- Layout atual: `EditProductFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/EditProductPage.xaml` e code-behind.
