# Issue 07 - Migrar InitDailyFragment para MAUI

## Meta
- Origem Android: `InitDailyFragment`
- Destino MAUI: `InitDailyPage`
- ViewModel: `InitDailyViewModel`
- Layout atual: `InitDailyFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `1d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/InitDailyPage.xaml` e code-behind.
