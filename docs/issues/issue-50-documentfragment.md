# Issue 50 - Migrar DocumentFragment para MAUI

## Meta
- Origem Android: `DocumentFragment`
- Destino MAUI: `DocumentPage`
- ViewModel: `DocumentViewModel`
- Layout atual: `DocumentFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `1d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/DocumentPage.xaml` e code-behind.
