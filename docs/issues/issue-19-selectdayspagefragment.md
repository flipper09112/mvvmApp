# Issue 19 - Migrar SelectDaysPageFragment para MAUI

## Meta
- Origem Android: `SelectDaysPageFragment`
- Destino MAUI: `SelectDaysPagePage`
- ViewModel: `SelectDaysPageViewModel`
- Layout atual: `SelectDaysPageFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `1d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/SelectDaysPagePage.xaml` e code-behind.
