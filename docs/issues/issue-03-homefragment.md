# Issue 03 - Migrar HomeFragment para MAUI

## Meta
- Origem Android: `HomeFragment`
- Destino MAUI: `HomePage`
- ViewModel: `HomeViewModel`
- Layout atual: `HomeFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `5d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/HomePage.xaml` e code-behind.
