# Issue 46 - Migrar NotificationsDashBoardFragment para MAUI

## Meta
- Origem Android: `NotificationsDashBoardFragment`
- Destino MAUI: `NotificationsDashBoardPage`
- ViewModel: `NotificationsDashBoardViewModel`
- Layout atual: `NotificationsDashBoardFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/NotificationsDashBoardPage.xaml` e code-behind.
