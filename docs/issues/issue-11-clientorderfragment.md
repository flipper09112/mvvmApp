# Issue 11 - Migrar ClientOrderFragment para MAUI

## Meta
- Origem Android: `ClientOrderFragment`
- Destino MAUI: `ClientOrderPage`
- ViewModel: `ClientOrderViewModel`
- Layout atual: `ClientOrderFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `3d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/ClientOrderPage.xaml` e code-behind.
