# Issue 42 - Migrar DatabaseManagerPageFragment para MAUI

## Meta
- Origem Android: `DatabaseManagerPageFragment`
- Destino MAUI: `DatabaseManagerPagePage`
- ViewModel: `DatabaseManagerPageViewModel`
- Layout atual: `DatabaseManagerPageFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/DatabaseManagerPagePage.xaml` e code-behind.
