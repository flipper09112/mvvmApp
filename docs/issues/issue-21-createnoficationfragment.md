# Issue 21 - Migrar CreateNoficationFragment para MAUI

## Meta
- Origem Android: `CreateNoficationFragment`
- Destino MAUI: `CreateNoficationPage`
- ViewModel: `CreateNoficationViewModel`
- Layout atual: `CreateNoficationFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/CreateNoficationPage.xaml` e code-behind.
