# Issue 32 - Migrar AddProductFragment para MAUI

## Meta
- Origem Android: `AddProductFragment`
- Destino MAUI: `AddProductPage`
- ViewModel: `AddProductViewModel`
- Layout atual: `AddProductFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/AddProductPage.xaml` e code-behind.
