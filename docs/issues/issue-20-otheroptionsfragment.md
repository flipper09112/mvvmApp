# Issue 20 - Migrar OtherOptionsFragment para MAUI

## Meta
- Origem Android: `OtherOptionsFragment`
- Destino MAUI: `OtherOptionsPage`
- ViewModel: `OtherOptionsViewModel`
- Layout atual: `OtherOptionsFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/OtherOptionsPage.xaml` e code-behind.
