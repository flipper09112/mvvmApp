# Issue 22 - Migrar ChangeDailyOrderFragment para MAUI

## Meta
- Origem Android: `ChangeDailyOrderFragment`
- Destino MAUI: `ChangeDailyOrderPage`
- ViewModel: `ChangeDailyOrderViewModel`
- Layout atual: `ChangeDailyOrderFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `3d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/ChangeDailyOrderPage.xaml` e code-behind.
