# Issue 13 - Migrar ChooseProductFragment para MAUI

## Meta
- Origem Android: `ChooseProductFragment`
- Destino MAUI: `ChooseProductPage`
- ViewModel: `ChooseProductViewModel`
- Layout atual: `ChooseProductFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `3d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/ChooseProductPage.xaml` e code-behind.
