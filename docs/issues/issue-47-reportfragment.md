# Issue 47 - Migrar ReportFragment para MAUI

## Meta
- Origem Android: `ReportFragment`
- Destino MAUI: `ReportPage`
- ViewModel: `ReportViewModel`
- Layout atual: `ReportFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/ReportPage.xaml` e code-behind.
