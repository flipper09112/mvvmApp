# Issue 37 - Migrar BtOutcomingFragment para MAUI

## Meta
- Origem Android: `BtOutcomingFragment`
- Destino MAUI: `BtOutcomingPage`
- ViewModel: `BtOutcomingViewModel`
- Layout atual: `BtOutcomingFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `3d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/BtOutcomingPage.xaml` e code-behind.
