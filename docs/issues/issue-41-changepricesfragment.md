# Issue 41 - Migrar ChangePricesFragment para MAUI

## Meta
- Origem Android: `ChangePricesFragment`
- Destino MAUI: `ChangePricesPage`
- ViewModel: `ChangePricesViewModel`
- Layout atual: `ChangePricesFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/ChangePricesPage.xaml` e code-behind.
