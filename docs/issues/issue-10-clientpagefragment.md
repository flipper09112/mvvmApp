# Issue 10 - Migrar ClientPageFragment para MAUI

## Meta
- Origem Android: `ClientPageFragment`
- Destino MAUI: `ClientPagePage`
- ViewModel: `ClientPageViewModel`
- Layout atual: `ClientPageFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `4d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/ClientPagePage.xaml` e code-behind.
