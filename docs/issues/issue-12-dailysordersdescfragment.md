# Issue 12 - Migrar DailysOrdersDescFragment para MAUI

## Meta
- Origem Android: `DailysOrdersDescFragment`
- Destino MAUI: `DailysOrdersDescPage`
- ViewModel: `DailysOrdersDescViewModel`
- Layout atual: `DailysOrdersDescFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/DailysOrdersDescPage.xaml` e code-behind.
