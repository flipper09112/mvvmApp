# Issue 08 - Migrar StopDailyFragment para MAUI

## Meta
- Origem Android: `StopDailyFragment`
- Destino MAUI: `StopDailyPage`
- ViewModel: `StopDailyViewModel`
- Layout atual: `StopDailyFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `1d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/StopDailyPage.xaml` e code-behind.
