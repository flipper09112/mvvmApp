# Issue 49 - Migrar SnoozeFragment para MAUI

## Meta
- Origem Android: `SnoozeFragment`
- Destino MAUI: `SnoozePage`
- ViewModel: `SnoozeViewModel`
- Layout atual: `SnoozeFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `1d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/SnoozePage.xaml` e code-behind.
