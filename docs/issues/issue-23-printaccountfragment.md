# Issue 23 - Migrar PrintAccountFragment para MAUI

## Meta
- Origem Android: `PrintAccountFragment`
- Destino MAUI: `PrintAccountPage`
- ViewModel: `PrintAccountViewModel`
- Layout atual: `PrintAccountFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/PrintAccountPage.xaml` e code-behind.
