# Issue 34 - Migrar FaturationFragment para MAUI

## Meta
- Origem Android: `FaturationFragment`
- Destino MAUI: `FaturationPage`
- ViewModel: `FaturationViewModel`
- Layout atual: `FaturationFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `3d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/FaturationPage.xaml` e code-behind.
