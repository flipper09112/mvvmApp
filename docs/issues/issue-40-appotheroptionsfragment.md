# Issue 40 - Migrar AppOtherOptionsFragment para MAUI

## Meta
- Origem Android: `AppOtherOptionsFragment`
- Destino MAUI: `AppOtherOptionsPage`
- ViewModel: `AppOtherOptionsViewModel`
- Layout atual: `AppOtherOptionsFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/AppOtherOptionsPage.xaml` e code-behind.
