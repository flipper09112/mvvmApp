# Issue 02 - Migrar LoginFragment para MAUI

## Meta
- Origem Android: `LoginFragment`
- Destino MAUI: `LoginPage`
- ViewModel: `LoginViewModel`
- Layout atual: `LoginFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/LoginPage.xaml` e code-behind.
