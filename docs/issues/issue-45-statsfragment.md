# Issue 45 - Migrar StatsFragment para MAUI

## Meta
- Origem Android: `StatsFragment`
- Destino MAUI: `StatsPage`
- ViewModel: `StatsViewModel`
- Layout atual: `StatsFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/StatsPage.xaml` e code-behind.
