# Issue 05 - Migrar HomePageMapFragment para MAUI

## Meta
- Origem Android: `HomePageMapFragment`
- Destino MAUI: `HomePageMapPage`
- ViewModel: `HomeViewModel`
- Layout atual: `HomePageMapFragment.xml`
- Prioridade: `ALTA`
- Estimativa: `3d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/HomePageMapPage.xaml` e code-behind.
