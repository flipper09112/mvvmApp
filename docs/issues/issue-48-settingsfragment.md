# Issue 48 - Migrar SettingsFragment para MAUI

## Meta
- Origem Android: `SettingsFragment`
- Destino MAUI: `SettingsPage`
- ViewModel: `SettingsViewModel`
- Layout atual: `SettingsFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/SettingsPage.xaml` e code-behind.
