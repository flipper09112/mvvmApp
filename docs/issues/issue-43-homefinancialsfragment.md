# Issue 43 - Migrar HomeFinancialsFragment para MAUI

## Meta
- Origem Android: `HomeFinancialsFragment`
- Destino MAUI: `HomeFinancialsPage`
- ViewModel: `HomeFinancialsViewModel`
- Layout atual: `HomeFinancialsFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/HomeFinancialsPage.xaml` e code-behind.
