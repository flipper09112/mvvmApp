# Issue 39 - Migrar MonthBillsHomeFragment para MAUI

## Meta
- Origem Android: `MonthBillsHomeFragment`
- Destino MAUI: `MonthBillsHomePage`
- ViewModel: `MonthBillsHomeViewModel`
- Layout atual: `MonthBillsHomeFragment.xml`
- Prioridade: `BAIXA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/MonthBillsHomePage.xaml` e code-behind.
