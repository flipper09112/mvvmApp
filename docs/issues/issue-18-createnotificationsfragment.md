# Issue 18 - Migrar CreateNotificationsFragment para MAUI

## Meta
- Origem Android: `CreateNotificationsFragment`
- Destino MAUI: `CreateNotificationsPage`
- ViewModel: `CreateNotificationsViewModel`
- Layout atual: `CreateNotificationsFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `2d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/CreateNotificationsPage.xaml` e code-behind.
