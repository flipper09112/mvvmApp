# Issue 26 - Migrar GlobalOrderSelectDaysFragment para MAUI

## Meta
- Origem Android: `GlobalOrderSelectDaysFragment`
- Destino MAUI: `GlobalOrderSelectDaysPage`
- ViewModel: `GlobalOrderSelectDaysViewModel`
- Layout atual: `GlobalOrderSelectDaysFragment.xml`
- Prioridade: `MÃ‰DIA`
- Estimativa: `1d`
- Status: `PENDENTE`
...
- [ ] Criar `Views/GlobalOrderSelectDaysPage.xaml` e code-behind.
