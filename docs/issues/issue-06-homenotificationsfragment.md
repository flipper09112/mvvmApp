# Issue 06 - Migrar HomeNotificationsFragment para MAUI

## Meta
- Origem Android: `HomeNotificationsFragment`
- Destino MAUI: `HomeNotificationsPage`
...
- [ ] Criar `Views/HomeNotificationsPage.xaml` e code-behind.
